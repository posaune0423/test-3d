...
const AppleInstallDialog = ({ handleCloseClick }: Props) => {
    ...
    <aside id='pwa-install-element'>
      <article className={`install-dialog apple available dialog-body ${collapsed || 'how-to'}`}>
        ...
        <div className='welcome-to-install'>
          This site has app functionality. Add it to your Home Screen for extensive experience and
          easy access.
        </div>
...
export default AppleInstallDialog
